        ...
        >
          <AnimatePresence>
            {filteredProjects.map((project) => {
              const isOnlyUI = project.tags.some(
                (tag) => tag.label === "UI"
              );
                  ...
                  <Card className="h-full flex flex-col group">
                    ...
                    <CardContent className="p-8 flex flex-col flex-1 relative overflow-hidden">
                      ...
                      <Button
                        ...
                        size="md"
                        disabled
                        className="rounded-xl font-body font-bold text-sm w-full sm:w-auto px-8 opacity-50 cursor-not-allowed"
                      >
                        Ver caso
                      </Button>
                    ) : (
                      ...
                      >
                        <Button
                          variant="primary"
                          size="md"
                          className="rounded-xl font-body font-bold text-sm w-full sm:w-auto px-8"
                        >
                          Ver caso
                        </Button>
                      </a>
